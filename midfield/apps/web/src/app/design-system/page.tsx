...
export default function DesignSystemPage() {
    return (
        <div className="w-full max-w-[1200px] mx-auto p-4 sm:p-8 lg:p-12 space-y-24 pb-32">
            ...
            {/* Right Panel Widgets */}
            <section className="space-y-8">
                <SectionHeader title="Right Panel Widgets" description="Sidebar widgets for trending topics and suggested follows." />

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {/* Trending Widget */}
                    <div className="space-y-3">
                        <span className="text-xs font-mono text-slate-400 dark:text-neutral-500 uppercase tracking-wider">Trending Topics</span>
                        <div className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-lg p-6">
                            ...
                            <div className="space-y-1">
                                {[
                                    { tag: "Messi", posts: "1.2k" },
                                    { tag: "ChampionsLeague", posts: "54k" },
                                    { tag: "TransferNews", posts: "8.9k" },
                                    { tag: "Mourinho", posts: "3.4k" },
                                ].map((item, index) => (
                                    <div key={index} className="flex items-center gap-4 p-3 rounded-md hover:bg-slate-50 dark:hover:bg-neutral-800 group cursor-pointer transition-colors">
                    ...
                    <div className="space-y-3">
                        <span className="text-xs font-mono text-slate-400 dark:text-neutral-500 uppercase tracking-wider">Who to Follow</span>
                        <div className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-lg p-6">
                            <h3 className="font-extrabold text-lg mb-4 text-slate-900 dark:text-neutral-100">Who to follow</h3>
                            <div className="space-y-4">
                                {[
                                    { name: "Fabrizio Romano", handle: "@fabriziorom" },
                                    { name: "Premier League", handle: "@premierleague" },
                                ].map((user, index) => (
