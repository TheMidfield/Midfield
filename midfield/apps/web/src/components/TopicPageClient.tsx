        ...
        <div className="min-h-screen">
            ...
            <EntityHeader
                ...
                metadata={{
                    ...
                    preferredFoot: metadata?.side || metadata?.preferred_foot,
                    birthLocation: metadata?.birth_location,
                                                        ...
                                                        return (
                                                            <div className="flex items-center gap-1.5 ml-2">
                                                                <Badge variant="secondary" className="text-[10px] sm:text-xs h-6 px-2 py-0 font-bold gap-1 flex items-center">
                                                                    ...
                                                                    <span className={`font-black ${getRatingColor(ovrRating)}`}>{ovrRating}</span>
                                                                </Badge>
                                                                                    ...
                                                                                    {validStats.map((stat) => (
                                                                                        <div key={stat.name} className="group">
                                                                                            ...
                                                                                            <div className="h-1.5 w-full bg-slate-100 dark:bg-neutral-800 rounded-full overflow-hidden">
                                                                                                <div
                                                                                                    className={`h-full rounded-full transition-all duration-500 ${getRatingBgColor(stat.value || 0)}`}
                                                    ...
                                                    {section.id === "stats" && isPlayer && (
                                                        <div className="pt-8 pb-6 flex flex-col items-center justify-center text-center opacity-70">
                                                            ...
                                                            <p className="text-xs text-slate-400 dark:text-neutral-500">
                                                                Advanced player data and stats coming soon
                                                            </p>
                                                        </div>
                                                    )}
