    ...
    return (
        ...
        >
            ...
            >
                ...
                <button
                    onClick={onClose}
                    className="absolute top-4 right-4 z-10 p-1.5 rounded-md text-slate-400 dark:text-neutral-500 hover:text-slate-700 dark:hover:text-neutral-200 hover:bg-slate-100 dark:hover:bg-neutral-800 transition-colors cursor-pointer"
                    aria-label="Close"
                >
                    <X className="w-5 h-5" />
                </button>
                ...
                {sent ? (
                    <div className="p-8 text-center space-y-4">
                        <div className="mb-4 w-16 h-16 bg-emerald-100 dark:bg-emerald-900/30 rounded-full flex items-center justify-center mx-auto">
                        ...
                        <p className="font-semibold text-slate-900 dark:text-neutral-100 break-all">
                            {email}
                        </p>
                        <p className="text-sm text-slate-500 dark:text-neutral-400 pt-4">
                    ...
                    <>
                        ...
                        <div className="relative px-6 pt-8 pb-5 sm:px-8 sm:pt-10 sm:pb-6 bg-gradient-to-br from-emerald-50 to-white dark:from-neutral-800 dark:to-neutral-900 border-b border-slate-100 dark:border-neutral-800/50">
                            <div className="relative flex items-center gap-4">
                                ...
                                <div className="space-y-0.5">
                                    {/* Headline */}
                                    <h2 className="text-xl font-bold text-slate-900 dark:text-neutral-100 leading-tight">
                                        {headline}
                                    </h2>
                                    <p className="text-sm text-slate-500 dark:text-neutral-400 leading-tight">
                                        {subheadline}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="p-6 sm:p-8 space-y-6">
                            ...
                            <button
                                ...
                                disabled={isPending}
                                style={{ width: '100%' }}
                                className="inline-flex items-center justify-center gap-3 h-12 px-6 rounded-md border-2 border-slate-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-slate-900 dark:text-neutral-100 font-bold hover:border-slate-400 dark:hover:border-neutral-500 hover:bg-slate-50 dark:hover:bg-neutral-800 transition-all active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none cursor-pointer"
                            >
                            ...
                            {/* Footer copy */}
                            <p className="text-xs text-center text-slate-500 dark:text-neutral-500">
